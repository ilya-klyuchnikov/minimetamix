...
/** The eXtended version of Nameless2: any order of variables in the body. */
trait Nameless2X {
  ...
  case class DFCall2_1(name: String, arg1: DVar, arg2: DVar) extends DExp2
  case class DFCall2_2(name: String, arg1: DVar, arg2: DVar) extends DExp2
  case class DGCall2_1(name: String, arg1: DVar, arg2: DVar) extends DExp2
  case class DGCall2_2(name: String, arg1: DVar, arg2: DVar) extends DExp2
  ...
  def dEval2(exp: DExp2, arg1: Val, arg2: Val): Val = exp match {
    case DFCall2_1(n, farg1, farg2) => dEvalF21(farg1, farg2, n, arg1, arg2)
    case DFCall2_2(n, farg1, farg2) => dEvalF21(farg1, farg2, n, arg2, arg1)
    case DGCall2_1(n, farg1, farg2) => dEvalG21(farg1, farg2, n, arg1, arg2)
    case DGCall2_2(n, farg1, farg2) => dEvalG21(farg1, farg2, n, arg2, arg1)
