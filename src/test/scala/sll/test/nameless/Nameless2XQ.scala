...
object Nameless2XQ {
  ...
  val program: Program = parseDefs {
    ...
    def eval2(exp: DExp2, arg1: Val, arg2: Val): Val = exp match {
      case DFCall2_1(n) => eval2(blaze(getF2(n)), arg1, arg2)
      case DFCall2_2(n) => eval2(blaze(getF2(n)), arg2, arg1)
      case DGCall2_1(n) => switch1(arg1, n, arg2)
      case DGCall2_2(n) => switch1(arg2, n, arg1)
